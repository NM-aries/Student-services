    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            @if (Auth::user()->is_admin == 1)
                ...
                <li class="nav-item " >
                    <span class="nav-link collapsed d-flex justify-content-between align-items-center active {{ (request()->is('admin/subscribers*')) ? 'bg-gray-700' : '' }}" data-bs-toggle="collapse" data-bs-target="#submenu-app">
                        <span>
                    ...
                    <div class="multi-level collapse {{ (request()->is('admin/subscribers*')) ? 'show' : '' }}" role="list" id="submenu-app" aria-expanded="false">
                        <ul class="flex-column nav">
                            <li class="nav-item ">
                                <a class="nav-link  {{ (request()->is('admin/subscribers')) ? 'bg-gray-900' : '' }} " href="{{ url('admin/subscribers') }}">
                                    <span class="sidebar-text">Email</span>
                                </a>
                            </li>
    
                            {{-- <li class="nav-item ">
                                <a class="nav-link {{ (request()->is('admin/subscribers/sms')) ? 'bg-gray-900' : '' }} " href="{{ url('admin/subscribers/sms') }}">
