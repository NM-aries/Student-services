...
@section('breadcrumbs')
    {{ Breadcrumbs::render('announcement_edit', $announcement) }}
@endsection
...
<div class="card border-0 shadow mb-4">
    <div class="card-body">
        <form action="{{url('admin/announcement/update/'.$announcement->id)}}" method="POST" role="form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" class="form-control" name="title" value="{{$announcement->title}}">
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    <label for="slug">Slug</label>
                                    <input type="text" id="slug" class="form-control" name="slug" value="{{$announcement->slug}}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-5 ">
                                        ...
                                        <div>
                                            <img class="cover_img" src="{{ asset('upload/announcement/'. $announcement->coverimage) }}" alt="">    
                                        </div>    
                                    </div>
                                ...
                                <input class="form-control" type="file" id="formFile" name="coverimage" value="{{$announcement->coverimage}}">
                            </div>
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="select2 form-control">
                                        <option value="1" {{ old('status') == $announcement->status ? 'selected' : ''}}>Publish</option>
                                        <option value="0" {{ old('status') == $announcement->status ? 'selected' : ''}}>Draft</option>
                                    </select>
                                </div>
                            </div>
