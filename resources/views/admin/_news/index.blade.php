...
@section('create_button')
    <a href="{{ url('admin/news/create') }}" class="btn btn-primary d-inline-flex align-items-center">
        Create News
    </a>
@endsection
