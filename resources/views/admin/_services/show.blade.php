...
@section('breadcrumbs')
    {{ Breadcrumbs::render('services_show', $services) }}
@endsection
...
<div class="card border-0 shadow mb-4">
    <div class="card-body">
        <div class="card-header p-0 pb-3">
            <h2>{{ ucfirst(trans( $services->title)) }}</h2>
            <div class="d-flex align-items-center mb-1" title="19 Jul 22 16:00 UTC">
                ...
                <small class="pt-1">Posted on: {{ $services->created_at->format('M d, Y') }}</small>
            </div>
        </div>
        ...
        <div class="card-body px-0 pb-4">
            ...
            @else
                <div class="col-12 col-md-12 mb-4">
                    <img src="{{asset('upload/announcement/'.$services->coverimage)}}">
                </div>
            @endif
            <div class="">
