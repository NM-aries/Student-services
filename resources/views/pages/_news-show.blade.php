...
<div class="container-fluid text-center bg-light-green shadow " id="title_container">
    <div class="container" >
            ...
            <div class="card-body bg-white">
                ...
                <div class="">
                    <div class="d-flex justify-content-between align-items-center">
                        @if ($prev)
                            <div class="_prev">
                                <a href="{{url('university_news/'.$prev->slug)}}" class=" btn bg-green text-white icon-left ">
                        ...
                        @if ($next)
                            <div class="_next ">
                                <a href="{{url('university_news/'.$next->slug)}}" class=" btn bg-green text-white icon-right ">
                                    Older Post
