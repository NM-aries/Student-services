            ...
            <div class="card-body bg-white">
                ...
                <div class="">
                    <div class="d-flex justify-content-between align-items-center">
                        @if ($prev)
                            <div class="_prev">
                                <a href="{{url('university_announcements/'.$prev->slug)}}" class=" btn btn-outline-danger icon-left ">
                        ...
                        @if ($next)
                            <div class="_next ">
                                <a href="{{url('university_announcements/'.$next->slug)}}" class=" btn btn-outline-danger icon-right ">
                                    Older Post
