<div class="container">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-4 ">
      ...
      <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
        ...
        <li class="ms-3">
            <a class="text-muted" href="https://discordapp.com/users/aRhiExz#1952" target="_blank">
        ...
        <li class="ms-3">
            <a class="text-muted" href="https://telegram.me/aRhiExz" target="_blank">
        ...
        <li class="ms-3">
            <a class="text-muted" href="https://github.com/NM-aries" target="_blank">
