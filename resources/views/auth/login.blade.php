                ...
                <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    ...
                    <form class="form form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group mb-4">
                            <label for="email">User ID Number</label>
                            <div class="input-group">
                                ...
                                <input type="text" name="user_id" class="form-control" id="user_id"  placeholder="User ID Number" required>
                            </div>
                        </div>
                        <!-- End of Form -->
                        <div class="form-group">
                            ...
                            <div class="d-flex justify-content-between align-items-top mb-4">
                                <div class="form-check">
                                    <input name="remember_token" class="form-check-input" type="checkbox" id="remember">
