                ...
                @foreach ($allAnnouncement as $listAnnouncement )
                    <div class="card mb-3 news">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title c-text-green fw-bold">{{$listAnnouncement->title}}</h5>
                                    <p class="lead card-text">
                                        {!! Str::limit($listAnnouncement->description, 150, $end=" .....") !!}
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a class="btn mt-2 btn-green  btn-sm" href="{{ url('university_announcements/'.$listAnnouncement->slug) }}"> 
                                            Continue Reading
                                        </a>
                                        <p class="card-text">
